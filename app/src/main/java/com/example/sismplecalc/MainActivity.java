package com.example.sismplecalc;
...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText mOperandEditTextOne;
    private EditText mOperandEditTextTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOperandEditTextOne = findViewById(R.id.valueOne);
        mOperandEditTextTwo = findViewById(R.id.valueTwo);
    }
...
//            mResultTextView.setText(getString(R.string.computationError));
    ...
    private void compute(Calculator.Operator operator){
        ...
        try {
            operandOne = getOperand(mOperandEditTextOne);
            operandTwo = getOperand(mOperandEditTextTwo);
